...
If a course does not have a date, then please join my [mailing list](mailing-list.html) to hear when new dates are confirmed. If you have any questions please do [contact me](index.html) or email [nick\@nickbearman.com](mailto:nick\@nickbearman.com).

----

|              | Introductory         | Advanced                               |
|--------------|-----------------------------------|-----------------------|
| R | [Introduction to Spatial Data and Using R as a GIS](#introduction-to-spatial-data-using-r-as-a-gis) June 2024       | [Confident Spatial Analysis and Statistics in R & GeoDa](#confident-spatial-analysis-and-statistics-in-r-geoda) July 2024 | [Confident Spatial Analysis and Statistics in R & GeoDa](#confident-spatial-analysis-and-statistics-in-r-geoda) 09/02/2025 
...
*This course is [Introduction to QGIS](#introduction-to-qgis-understanding-and-presenting-spatial-data) and [Confident Spatial Analysis in QGIS](#confident-spatial-analysis-in-qgis) run back to back.*
...
*This course is a combination of the four courses listed above.*

[Mon 22nd – Fri 26th July, 2024, 10am – 1:30pm, hybrid.](https://essexsummerschool.com/summer-school-facts/courses/ess-2024-course-list/1p-introduction-to-gis-geospatial-data-and-spatial-analysis/)
...
I have also run a number of other courses, usually based on the four courses above and tweaked for a bespoke audience (example clients include Public Health Wales, Red Bull, National Trails UK and UEA International Development). 

I also deliever bespoke GIS training one-to-one and small groups on a [consultancy](consultancy.html) basis. 
