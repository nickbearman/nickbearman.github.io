...
I offer a variety of training courses on GIS and spatial data, both in person and online using Zoom. I offer Introductory and Advanced Training in QGIS and R. My training is designed to both teach you about GIS itself and how to use the software to do make maps and perform spatial analysis. My courses are constantly being developed to take advantage of the latest changes in QGIS and R. If you would like a course run for a group of you, then please contact me discuss your needs and for a quote.

Below is a list of the courses coming up, and a link to sign up (where available). If you would like to participate in any of the courses, please either email nick\@geospatialtrainingsolutions.co.uk or use the contact form on this website. If a course does not have a date, then please join my mailing list to hear when new dates are confirmed.
...
|              | R                                                                                                                          | QGIS                                                                              |
|--------------|----------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
| Introductory | [Introduction to Spatial Data & Using R as a GIS](#introduction-to-spatial-data-using-r-as-a-gis) 09/01/2024 CC            | [Introduction to QGIS: Understanding and Presenting Spatial Data]\* 09/01/2025 CC |
...
### Introduction to Spatial Data & Using R as a GIS {#introduction-to-spatial-data-using-r-as-a-gis}
