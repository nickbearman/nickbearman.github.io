...
Later on, I also spent a lot of time working with ArcMap 9.2 (above), which I used in my programming skills to use VBA (Visual Basic Applications) code to create a map that made sounds - an area called [sonification](https://www.nickbearman.me.uk/sonification/), which formed part of my early research interests.
