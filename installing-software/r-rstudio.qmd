...
- Download the latest version (4.6.1 at time of writing) **Download R-4.6.1 for Windows**. 
...
- Download the latest version (2026.07.01-147 at the time of writing). 
...
- Download the latest version (4.6.1 at time of writing) **R-4.6.1-arm64.pkg**. 
- Run through the program installation process.  
- Once R is installed, we can install RStudio. 
- Go to [https://posit.co/download/rstudio-desktop/#download](https://posit.co/download/rstudio-desktop/#download). 
