...
<!-- QGIS Mac should now be signed, so don't need the below as at 2026-02-11 
...
- Follow the instructions for the appropriate Linux distribution to install the latest long term release version (currently 3.44).  
